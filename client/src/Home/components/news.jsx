    ...
    <div  style={{ padding: `0 ${chevronWidth}px`,overflow:'none' }}>
      ...
      >
        ...
        <div style={{ height:650,width:500,background: '' }}>
                  <div>
                  <div className="Game" >
                  <img src="https://static.invenglobal.com/upload/image/2020/06/24/i1593008763944016.jpeg" width="453.5px" height="300" />
        ...
        <div style={{ height:650,height:500,background: '' }}>
                  <div>
                  <div className="Game"  >
                  <img src="https://pbs.twimg.com/media/EbSieHIWoAExsLq?format=jpg&name=small"  width="433px" height="300"  />
        ...
        <div style={{ height: 650,height:500,boder: '' }}>
                  <div >
                  <div className="CardN">
                  <img src="https://i0.wp.com/www.nintendoenthusiast.com/wp-content/uploads/2020/06/poketune-pokemon-looney-tunes-800x400.png?resize=650,400" width="433px" height="300" />
        ...
        <div style={{ height: 650,height:500,boder: '' }}>
                  <div >
                  <div className="CardN">
                  <img src="https://www.einerd.com.br/wp-content/uploads/2020/04/Pok%C3%A9mon-Equipe-Rocket-capa.jpg" width="433px" height="300" />
                ...
                <div style={{ height: 650,height:500,boder: '' }}>
                  <div >
                  <div className="CardN">
                  <img src="https://observatoriodegames.uol.com.br/wp-content/uploads/2020/06/Ahs-and-Pikachuu--696x392.jpg" width="433px" height="300" />
