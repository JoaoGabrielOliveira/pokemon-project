...
<strong className="titu" >O que é Pokedex?</strong>
   ...
   Em geral, quando são cumpridos determinados requisitos, a capacidade pode ser aumentada permitindo que a Pokédex possa armazenar dados de outros Pokémon. <br></br>
  </div> 
  </div> 
   <div className="btn1">
    <a href="/Pokemons" className="btn"  ><strong>ver pokedex </strong></a >
        </div>
     </div>
</div>
